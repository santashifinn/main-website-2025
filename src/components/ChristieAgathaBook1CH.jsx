import christieagathabk1_0 from "/assets/christieagathabook1ch.jpg";

const ChristieAgathaBook1CH = () => {
  return (
    <>
...
export default ChristieAgathaBook1CH;
