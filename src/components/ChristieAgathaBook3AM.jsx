import christieagathabk3_0 from "/assets/christieagathabook3am.jpg";

const ChristieAgathaBook3AM = () => {
  return (
    <>
      <section className="books-editions">
        <section className="books-editions1">
          <img
            ...
            alt="Քրիսթիի և Ագաթայի խուզարկուական գործակալություն. Մի դամբարան գլխացավանք"
          />
        </section>
        <section className="books-editions2">
          ...
          <p>
            <span className="italics">
              Քրիսթիի և Ագաթայի խուզարկուական գործակալություն. Մի դամբարան
              գլխացավանք
            </span>
          </p>
          <p>
          ...
          <p>
            <a
              href="https://daran.company.site/Փիփ-Մըրֆի-Քրիսթիի-և-Ագաթայի-խուզարկուական-գործակալություն-Մի-դամբարան-գլխացավանք-p833243315"
              target="_blank"
            >
...
export default ChristieAgathaBook3AM;
