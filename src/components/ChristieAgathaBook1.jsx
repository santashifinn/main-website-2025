...
import ChristieAgathaBook1RO from "./ChristieAgathaBook1RO";
import ChristieAgathaBook1CH from "./ChristieAgathaBook1CH";
import ChristieAgathaBook1AM from "./ChristieAgathaBook1AM";
        ...
        <section className="books-individual2">
          ...
          <section className="books-individual-buy">
            ...
            <section className="books-individual-buy-lang">
              ...
              <span className="accent-books">{" • "}</span>
              <button onClick={() => setBookEdition("RO")}>
                <span className="underline">
                  {" "}
                  {bookEdition === "RO" ? (
                    <span className="strong">Romanian</span>
                  ) : (
                    "Romanian"
                  )}
                </span>
              ...
              <span className="accent-books">{" • "}</span>{" "}
              <button onClick={() => setBookEdition("AM")}>
                <span className="underline">
                  {bookEdition === "AM" ? (
                    <span className="strong">Armenian</span>
                  ) : (
                    "Armenian"
                  )}
                </span>
            ...
            {bookEdition === "DE" ? (
              ...
              <ChristieAgathaBook1CH />
            ) : bookEdition === "CZ" ? (
              <ChristieAgathaBook1CZ />
            ) : bookEdition === "SK" ? (
              <ChristieAgathaBook1SK />
            ) : bookEdition === "RO" ? (
              <ChristieAgathaBook1RO />
            ) : bookEdition === "TR" ? (
              <ChristieAgathaBook1TR />
            ) : bookEdition === "AM" ? (
              <ChristieAgathaBook1AM />
            ) : bookEdition === "AR" ? (
