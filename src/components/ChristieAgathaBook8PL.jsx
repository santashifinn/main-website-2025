import christieagathabk8_0 from "/assets/christieagathabook8pl.jpg";

const ChristieAgathaBook8PL = () => {
  return (
    <>
      <section className="books-editions">
        <section className="books-editions1">
          <img
            ...
            alt="Agencja detektywistyczna Christie i Agaty. Tom 8. Zła nuta"
          />
        </section>
        <section className="books-editions2">
          ...
          <p>
            <span className="italics">
              Agencja detektywistyczna Christie i Agaty. Tom 8. Kocia katastrofa
            </span>
          </p>
          <p>
            <span className="strong">Publisher:</span> Tandem
            <br />
            <span className="strong">Published:</span> 06. 08. 2026
          </p>
          <p>
          ...
          <p>
            ...
            <a
              href="https://www.gandalf.com.pl/kocia-katastrofa-p-2053582.html"
              target="_blank"
            >
...
export default ChristieAgathaBook8PL;
