import christieagathabk6_0 from "/assets/christieagathabook6pl.jpg";

const ChristieAgathaBook6PL = () => {
  return (
    <>
      <section className="books-editions">
        <section className="books-editions1">
          <img
            ...
            alt="Agencja detektywistyczna Christie i Agaty. Tom 6. Jak powstrzymać
              wielki skok?"
          />
        </section>
        <section className="books-editions2">
          ...
          <p>
            <span className="italics">
              Agencja detektywistyczna Christie i Agaty. Tom 6. Jak powstrzymać
              wielki skok?
            </span>
          </p>
          <p>
            ...
            <br />
            <span className="strong">Published:</span> 17. 04. 2026
          </p>
          <p>
          ...
          <p>
            ...
            <a
              href="https://www.gandalf.com.pl/jak-powstrzymac-wielki-skok-agencja-detektywistyczna-christie-i-agaty-tom-6-p-2023601.html"
              target="_blank"
            >
...
export default ChristieAgathaBook6PL;
