import christieagathabk3_0 from "/assets/christieagathabook3ch.jpg";

const ChristieAgathaBook3CH = () => {
  return (
    <>
...
export default ChristieAgathaBook3CH;
