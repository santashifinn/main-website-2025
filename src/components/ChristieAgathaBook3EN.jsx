      ...
      <section className="books-editions">
        ...
        <section className="books-editions2">
          ...
          <p>
            ...
            <br />
            <span className="strong">Published:</span> 9. 2022
          </p>
          <h3>Where to Buy</h3>
          <p>
            <a
              href="https://www.waterstones.com/book/tombful-of-trouble/pip-murphy/roberta-tedeschi/9781782268161"
              target="_blank"
            >
              <button className="books-buy-button">Waterstones</button>
            </a>
            <a href="https://amzn.eu/d/dOP6zwH" target="_blank">
              <button className="books-buy-button">Amazon UK</button>
            </a>
            <a
              href="https://uk.bookshop.org/p/books/tombful-of-trouble-pip-murphy/6912970"
              target="_blank"
            >
...
export default ChristieAgathaBook3EN;
